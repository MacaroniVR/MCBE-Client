...
namespace SDK {
    ...
    //   0x654 = render camera pos (X/Y/Z) — CONFIRMED for OUR chain (renderLevel
    //           arg +0x468 -> LevelRendererPlayer) by decompiling FUN_14314eac0 on
    //           the actual 1.21.51 binary: it reads cameraPos at 0x654/0x658/0x65c
    //           and view target at 0x660/0x664/0x668, and uses 0x654 for chunk
    //           distance sorting. Flarial's 0x6E4 is a DIFFERENT struct/chain.
