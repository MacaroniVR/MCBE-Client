...
namespace ClientCapture {
    ...
    static const char* SIG =
        "48 8B C4 48 89 58 18 55 56 57 41 54 41 55 41 56 41 57 48 8D A8 C8 FE FF FF "
        "48 81 EC 00 02 00 00 0F 29 70 B8 0F 29 78 A8 44 0F 29 40 98 44 0F 29 48 88 "
        "44 0F 29 90 78 FF FF FF 44 0F 29 A0";
    ...
    static void __fastcall hkUpdate(void* thisPtr, void* a2) {
        // this = ClientInstance. Cache it.
        if (thisPtr) g_clientInstance = reinterpret_cast<uintptr_t>(thisPtr);
